...
import 'package:all_in_one_games/games/number_link/services/cat_skin_service.dart';
import 'package:all_in_one_games/games/number_link/services/dog_skin_service.dart';
import 'package:all_in_one_games/games/number_link/services/ghost_skin_service.dart';
import 'package:all_in_one_games/games/number_link/services/monster_skin_service.dart';
...
class _GameBoardUnityStyleState extends State<GameBoardUnityStyle> {
  ...
  Widget _buildNodeIndicator(
    ...
    switch (style) {
      ...
      case CellStyle.animal:
        // Animal image (Terminal Node) - image on colored background, no triangles, with intense white glow around shape
        return Stack(
          children: [
            // Colored background using primary color
            Container(
              width: cellSize,
              height: cellSize,
              color: cellColor,
            ),
            // Intense white glow - multiple blurred layers
            ImageFiltered(
              ...
              child: Opacity(
                ...
                child: ColorFiltered(
                  ...
                  child: Image.asset(
                    AnimalSkinService.getAnimalAssetPath(cellValue),
                    width: cellSize,
                    height: cellSize,
                    fit: BoxFit.cover,
                  ),
      ...
      case CellStyle.cat:
        // Cat image (Terminal Node) - image on colored background, no triangles, with intense white glow around shape
        return Stack(
          children: [
            // Colored background using primary color
            Container(
            ...
            ImageFiltered(
              ...
              child: Opacity(
                ...
                child: ColorFiltered(
                  colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcATop),
                  child: Image.asset(
                    CatSkinService.getCatAssetPath(cellValue),
                    width: cellSize,
                    height: cellSize,
                    fit: BoxFit.cover,
                  ),
      ...
      case CellStyle.dog:
        // Dog image (Terminal Node) - image on colored background, no triangles, with intense white glow around shape
        return Stack(
          children: [
            // Colored background using primary color
            Container(
            ...
            ImageFiltered(
              ...
              child: Opacity(
                ...
                child: ColorFiltered(
                  colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcATop),
                  child: Image.asset(
                    DogSkinService.getDogAssetPath(cellValue),
                    width: cellSize,
                    height: cellSize,
                    fit: BoxFit.cover,
                  ),
      ...
      case CellStyle.ghost:
        // Ghost image (Terminal Node) - image on colored background, no triangles, with intense white glow around shape
        return Stack(
          children: [
            // Colored background using primary color
            Container(
            ...
            ImageFiltered(
              ...
              child: Opacity(
                ...
                child: ColorFiltered(
                  colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcATop),
                  child: Image.asset(
                    GhostSkinService.getGhostAssetPath(cellValue),
                    width: cellSize,
                    height: cellSize,
                    fit: BoxFit.cover,
                  ),
      ...
      case CellStyle.monster:
        // Monster image (Terminal Node) - image on colored background, no triangles, with intense white glow around shape
        return Stack(
          children: [
            // Colored background using primary color
            Container(
            ...
            ImageFiltered(
              ...
              child: Opacity(
                ...
                child: ColorFiltered(
                  colorFilter: const ColorFilter.mode(Colors.white, BlendMode.srcATop),
                  child: Image.asset(
                    MonsterSkinService.getMonsterAssetPath(cellValue),
                    width: cellSize,
                    height: cellSize,
                    fit: BoxFit.cover,
                  ),
  ...
  Widget _buildCellContent(
    ...
    switch (style) {
      ...
      case CellStyle.ghost:
      case CellStyle.monster:
        // New image skins use standard primary colors for regular cells
        return Container(
          width: cellSize,
          height: cellSize,
          color: cellColor,
                    ...
                    return Container(
                      ...
                      child: Stack(
                        ...
                        children: [
                          ...
                          // Bridges for new image skins (animal, cat, dog, ghost, monster) - Use primary color
                          if ((gameState.cellStyle == CellStyle.animal ||
                               gameState.cellStyle == CellStyle.cat ||
                               gameState.cellStyle == CellStyle.dog ||
                               gameState.cellStyle == CellStyle.ghost ||
                               gameState.cellStyle == CellStyle.monster) && hasRightNeighbor) ...[
                             Positioned(
                               left: cellSize,
                               top: 0,
                               child: Container(
                          ...
                          if ((gameState.cellStyle == CellStyle.animal ||
                               ...
                               gameState.cellStyle == CellStyle.dog ||
                               gameState.cellStyle == CellStyle.ghost ||
                               gameState.cellStyle == CellStyle.monster) && hasBottomNeighbor) ...[
                             Positioned(
                               top: cellSize,
                               left: 0,
                               child: Container(
